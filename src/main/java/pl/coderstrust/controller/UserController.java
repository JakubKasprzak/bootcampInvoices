...
public class UserController {
    ...
    public ResponseEntity<?> add(@RequestBody(required = false) User user) {
        ...
        try {
            if (user.getId() != null && userService.userExistsById(user.getId())) {
    ...
    @ApiOperation(value = "Update user", notes = "Update user with provided id", response = Invoice.class)
    @ApiResponses({
    ...
    @ApiImplicitParams({
        ...
        @ApiImplicitParam(required = true, name = "user", value = "Invoice with updated data", dataType = "Invoice")
    })
    ...
    @ApiOperation(value = "Find by email", notes = "Finds user by given email", response = Invoice.class)
    @ApiResponses({
        @ApiResponse(code = 200, message = "OK", response = Invoice.class),
        @ApiResponse(code = 400, message = "Bad request"),
    ...
    @ApiImplicitParam(required = true, name = "number", value = "Email of the user to get", dataType = "String")
